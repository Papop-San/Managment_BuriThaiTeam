...
// ฟังก์ชันช่วย crop รูปจาก canvas (แก้ไขให้รับ croppedAreaPixels แทน crop/zoom)
async function getCroppedImg(
  ...
  // กำหนดขนาด canvas ตามขนาด crop จริง
...
export default function AccountForm() {
  ...
  // รับตำแหน่ง crop pixel ที่ user เลือกจาก react-easy-crop
    ...
    <Form {...form}>
      <div className="max-w-6xl mx-auto p-10 mt-20 bg-white rounded-lg shadow-md border border-gray-200">
        <div className="text-center mb-8">
          <p className="text-4xl font-bold">Account Create</p>
        </div>
                    ...
                    <FormControl>
                      <div
                        ...
                        style={{
                          ...
                          maxWidth: 300,
                          height: "auto",
                          aspectRatio: "1 / 1", // ทำให้เป็นสี่เหลี่ยมจัตุรัส responsive
                          minHeight: 300,
                        }}
                      >
                        <input {...getInputProps()} />
          ...
          <div className="bg-white rounded-lg p-4 max-w-md w-full">
            <div style={{ position: "relative", width: "100%", height: 400 }}>
              <Cropper
                ...
                onCropComplete={onCropComplete} // <-- เพิ่มตรงนี้
              />
            </div>
