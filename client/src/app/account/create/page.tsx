    ...
    <Form {...form}>
      <Card className="max-w-6xl mx-auto mt-20 p-6">
        <CardHeader className="text-center mt-5">
          <CardTitle className="text-4xl font-bold">Account Create</CardTitle>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input {...field} className="text-xl p-3 font-medium" placeholder="Username" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input {...field} type="email" className="text-xl p-3 font-medium" placeholder="Email" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input {...field} className="text-xl p-3 font-medium" placeholder="First Name" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input {...field} className="text-xl p-3 font-medium" placeholder="Last Name" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
              ...
              <div className="grid gap-8 md:grid-cols-2">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input {...field} className="text-xl p-3 font-medium" placeholder="Phone Number" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  rules={{
                    ...
                    validate: (value) => (!value ? "Birth date is required" : new Date(value) > new Date() ? "Birth date cannot be in the future" : true),
                  }}
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-lg font-semibold">Birth Date</FormLabel>
                      <FormControl>
                        <Input {...field} className="text-xl p-3 font-medium" type="date" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                      ...
                      <div className="flex gap-6 text-lg flex-wrap">
                        {["male", "female", "other"].map((value) => (
                          <label key={value} className="inline-flex items-center space-x-3 cursor-pointer">
                            <input type="radio" value={value} checked={field.value === value} onChange={() => field.onChange(value)} className="form-radio w-6 h-6" />
